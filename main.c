									...
									if (scanf("%lf", &NetMaas) != 1) {
										...
										if(NetMaas < 0) {
											...
											if(scanf("%lf", &MesaiSaatiNormal) != 1) {
												...
												printf("Mesai saati degeri yalnızca sayısal degerlerden oluşmalıdır!");
													...
													if(scanf("%lf", &MesaiSaatiResmi) != 1) {
														...
														if (MesaiSaatiResmi < 0) {
															...
															if (scanf("%d", &eksikGelinenGun) != 1) {
																...
																printf("Eksik gelinen gun degeri yalnızca sayısal degerlerden oluşmalıdır!");
																...
																if(eksikGelinenGun < 0) {
																	...
																	if(scanf("%lf", &eksikGelinenSaat) != 1) {
																		...
																		printf("Eksik gelinen saat degeri yalnızca sayısal degerlerden oluşmalıdır!");
															...
															printf("Matematiksel olarak 1 aylık mesai degeri mantikli degil!");
